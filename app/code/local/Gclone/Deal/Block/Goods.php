...
class Gclone_Deal_Block_Goods extends Mage_Core_Block_Template {

    protected function _prepareLayout() {
        $this->setToolbar($this->getLayout()->createBlock('page/html_pager', 'deal_goods_toolbar'));
	...
	$dealVisibility[1]='4';
        ...
        $_productCollection = Mage::getModel('catalog/product')->getCollection()
                            //->addAttributeToFilter('weight', array('gteq' => '1'))
