...
class Mage_Page_Block_Html_Pager extends Mage_Core_Block_Template
{
    ...
    public function getLimit()
    {
        ...
        if ($limit = Mage::getStoreConfig('catalog/frontend/grid_per_page')) {
            if (isset($limits[$limit])) {
                return $limit;
            }
        }
        $limits = Mage::getStoreConfig('catalog/frontend/grid_per_page');
        return $limits;
    }
    ...
    {
       $pages = Mage::getStoreConfig('catalog/frontend/grid_per_page_values');
       $pageArray = explode(",",$pages);
       $this->_availableLimit = $pageArray;
