...
class Mage_Catalog_Model_Layer extends Varien_Object
{
    ...
    public function prepareProductCollection($collection)
    {
       ...
       $cityId = Mage::getSingleton('core/session')->getCity();
        $currentTime = Mage::getModel('core/date')->date('Y-m-d');
        $collection
            ->addAttributeToSelect(Mage::getSingleton('catalog/config')->getProductAttributes())
            ->addAttributeToSelect('customer_website')
            ->addAttributeToSelect('time')
            ->addAttributeToSelect('customersite')
            ->addAttributeToSelect('subtitle')
            ->addAttributeToFilter('special_from_date', array('lt' => $currentTime))
            ->addAttributeToFilter('special_to_date', array('gt' => $currentTime))
