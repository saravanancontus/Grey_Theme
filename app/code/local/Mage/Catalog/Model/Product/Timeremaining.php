...
class Mage_Catalog_Model_Product_Timeremaining extends Mage_Core_Model_Abstract {
    ...
    */
    public static function timeConversion($gvnSeconds) {

        $days = (int) (intval($gvnSeconds) / (3600*24));
        $hrs = (int) (intval($gvnSeconds) / 3600) % 24; ;
        $mins = (int) (intval($gvnSeconds) / 60) % 60;;
        $secs = (int) ( $gvnSeconds % 60 ) ;

        $daily = $days.' days '.$hrs . " hrs " . $mins ." mins";
