...
class Apptha_Adddeals_Block_Adminhtml_Adddeals_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('adddeals/adddeals')->getCollection();
  ...
  {
      $this->addColumn('adddeals_id', array(
          'header'    => Mage::helper('adddeals')->__('ID'),
          'align'     =>'right',
          'width'     => '50px',
          'index'     => 'adddeals_id',
      ));
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('adddeals')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('adddeals')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
      ...
      $this->addColumn('status', array(
          'header'    => Mage::helper('adddeals')->__('Status'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'status',
          'type'      => 'options',
        ...
        $this->addColumn('action',
            array(
                'header'    =>  Mage::helper('adddeals')->__('Action'),
                'width'     => '100',
                'type'      => 'action',
                'getter'    => 'getId',
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('adddeals')->__('Edit'),
                        'url'       => array('base'=> '*/*/edit'),
                        'field'     => 'id'
                    )
                ),
