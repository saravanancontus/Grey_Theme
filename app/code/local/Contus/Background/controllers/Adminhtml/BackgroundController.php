...
class Contus_Background_Adminhtml_BackgroundController extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction() {
        if ($data = $this->getRequest()->getPost()) {
            ...
            $collection = Mage::getModel('background/background')->getCollection()->addFieldToFilter('city', $data['city'])->addFieldToFilter('store', $data['store']);
            $cityCount = count($collection);
            if ($cityCount != '' && $this->getRequest()->getParam('id') == '') {
                $cityCollection = $collection->getItems();
                foreach ($cityCollection as $city) {
                    $id = $city['background_id'];
                }
