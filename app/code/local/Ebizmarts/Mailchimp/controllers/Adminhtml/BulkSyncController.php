	...
	public function runAction() {
		...
		if(isset($params['time'],$params['type'],$params['list'],$params['key'])){
			try {
				...
				if(isset($s['error_count']) && $s['error_count']) {
					$this->_getSession()->addSuccess($helper->__('%s error(s) found, please review the log file for further details..',$s['error_count']));
