...
var links = document.links;
    ...
    for (i = 0; i < links.length; i++) {
        ...
        links[i].href = 'javascript:apptha_header_logo_Div.open1();';
...
$('.col-2 .buttons-set').each(function(e) {
        ...
        e.insert({bottom: '<div id="multilogin"> <button type="button" class="button" style="" onclick="javascript:apptha_header_logo_Div.open1();" title="Social Login" name="headerboxLink1" id="headerboxLink1"><span><span>Social Login</span></span></button></div>'});
