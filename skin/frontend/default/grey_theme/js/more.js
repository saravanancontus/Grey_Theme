      ...
      var sum=0;
      var i=1;
       jqs(".nav-container ul:not('.level0'):not('.level1') > li").each(function(){
           if(jqs(this).width())
           {
               sum +=jqs(this).width();
               if(sum >800)
               {
                   str += "<li class='more_sub_item'>"+ jqs(this).html()+ "<span></span></li>";
                   if(i==1){
       ...
       str ="<li  class='more_li'><a href='javascript:void(0);' class='more_link'>More </a><span></span><ul>"+str+"</ul></li>";
